...
def create_ai_catastrophe_description():
    return """
Придумай уникальную катастрофу, которая может случиться в настоящем мире. Мне нужно: 
...
Придумай подходящий бункер , который помогает людям противостоять этой катастрофе. Нужно: 
    ...
    Количество мест  — сколько человек может находиться в бункере одновременно.
