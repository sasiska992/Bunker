...
class PlayerCards(Base):
    ...
    def __init__(self, user_id:str, room_id: str, sex: str, age: str, health: str, profession: str, inventory: str, phobia: str, hobby: str, violation_of_law: str, additional_information: str, bad_habits: str, work_experience: str, impact_of_disaster: str):
